...
function getFlickrImages() {
		var flickrUrl = 'https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=51ca6a1dd5e233c1626943106fb7a018&text=Central+park+zoo&accuracy=16&lat=40.7678&lon=-73.971669&format=json';
        $.ajax({
            url: flickrUrl,
            dataType: 'jsonp',
            jsonp: 'jsoncallback',
